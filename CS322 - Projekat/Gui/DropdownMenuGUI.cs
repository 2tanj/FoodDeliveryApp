...
{
    //CREDIT: https://github.com/RJCodeAdvance/Dropdown-Menu-CSharp-WinForms
    public class DropdownMenuGUI : ContextMenuStrip
    {
        //Fields
        ...
        //Constructor
        public DropdownMenuGUI(IContainer container)
            : base(container)
        {
